/**
  ...
  ******************************************************************************
  */
#ifndef AI_STRETCH_LSTM_H
#define AI_STRETCH_LSTM_H

#include "stretch_lstm_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_STRETCH_LSTM_MODEL_NAME          "stretch_lstm"
#define AI_STRETCH_LSTM_ORIGIN_MODEL_NAME   "stretch_tanh"

/******************************************************************************/
#define AI_STRETCH_LSTM_ACTIVATIONS_ALIGNMENT   (4)
#define AI_STRETCH_LSTM_INPUTS_IN_ACTIVATIONS   (4)
#define AI_STRETCH_LSTM_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_STRETCH_LSTM_IN_NUM        (1)

AI_DEPRECATED
#define AI_STRETCH_LSTM_IN \
  ai_stretch_lstm_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_STRETCH_LSTM_IN_SIZE { \
  AI_STRETCH_LSTM_IN_1_SIZE, \
}
#define AI_STRETCH_LSTM_IN_SIZE_BYTES { \
  AI_STRETCH_LSTM_IN_1_SIZE_BYTES, \
}
#define AI_STRETCH_LSTM_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STRETCH_LSTM_IN_1_HEIGHT      (1)
#define AI_STRETCH_LSTM_IN_1_CHANNEL     (1)
#define AI_STRETCH_LSTM_IN_1_SIZE        (1)
#define AI_STRETCH_LSTM_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_STRETCH_LSTM_OUT_NUM       (1)

AI_DEPRECATED
#define AI_STRETCH_LSTM_OUT \
  ai_stretch_lstm_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_STRETCH_LSTM_OUT_SIZE { \
  AI_STRETCH_LSTM_OUT_1_SIZE, \
}
#define AI_STRETCH_LSTM_OUT_SIZE_BYTES { \
  AI_STRETCH_LSTM_OUT_1_SIZE_BYTES, \
}
#define AI_STRETCH_LSTM_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STRETCH_LSTM_OUT_1_CHANNEL     (1)
#define AI_STRETCH_LSTM_OUT_1_SIZE        (1)
#define AI_STRETCH_LSTM_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_STRETCH_LSTM_N_NODES (2)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup stretch_lstm
 ...
 * @ref ai_stretch_lstm_create. Both the activations memory buffer 
 ...
 * using @ref ai_stretch_lstm_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stretch_lstm_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stretch_lstm_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_STRETCH_LSTM_*
 * defines into file @ref stretch_lstm.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_stretch_lstm_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_STRETCH_LSTM_H */
